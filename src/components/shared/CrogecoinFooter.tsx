  ...
  return (
    <footer className="pl-[25px] md:pl-[55px]">
      <div className="flex items-end mb-[30px]">
        <h2 className="text-[35.3px]  md:text-[69.3px] font-[600] leading-[100%] mr-[5.5px] md:mr-[22.5px] text-[#FFF]">
          Why&nbsp;Cronos?
        </h2>
        <Image
      ...
      <p className="text-[15.6px] md:text-[25.6px] font-[600]  mb-[185px] text-[#FFF]">
